...
export function Login(props) {
  ...
  const [isTextInputActive, setIsTextInputActive] = React.useState(false);
  let t0;
  ...
  let t2;
  if ($[6] !== props.startingMessage || $[7] !== setIsTextInputActive || $[8] !== t1) {
    t2 = <ConsoleOAuthFlow onDone={t1} startingMessage={props.startingMessage} onTextInputActiveChange={setIsTextInputActive} />;
    $[6] = props.startingMessage;
    $[7] = setIsTextInputActive;
    $[8] = t1;
    $[9] = t2;
  } else {
    t2 = $[9];
  ...
  let t3;
  if ($[10] !== isTextInputActive || $[11] !== t0 || $[12] !== t2) {
    t3 = <Dialog title="Login" onCancel={t0} color="permission" inputGuide={_temp} isCancelActive={!isTextInputActive}>{t2}</Dialog>;
    $[10] = isTextInputActive;
    $[11] = t0;
    $[12] = t2;
    $[13] = t3;
  } else {
